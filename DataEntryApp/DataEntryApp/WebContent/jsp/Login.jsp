												...
												<table width="98%" align="center" border="0">
													<tr>
														...
														<td align="left" width="14%">															 								
															<s:textfield name="username" id="username" cssClass="textbox" size="20" onblur="fnSetBiometricUser(this);" onchange="fnLaunchBiometricCapture(this);" autocomplete="off" title="Please Agree with the Terms & Conditions also"/>
														</td>	
													...
													<tr>
														...
														<td align="left" width="14%">		
															<s:password name="password" id="password"  cssClass="textbox" size="22" title="Please Agree with the Terms & Conditions also" disabled="true"/>
														</td>
													</tr>
													<tr>
														<td align="right" width="43%">
														...
														<td align="left" width="14%">		
															...
															<s:submit method="execute" id="btnSubmit" key="label.login" align="right" cssClass="groovybutton" title="Please Agree with the Terms & Conditions also" style="display:none;" disabled="true"/>
														</td>
													</tr>		
													<tr>
